...
class Indicators
{
     ...
     *      Money flow index
     */
    public function mfi($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
     ...
     */
    public function cci($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
     ...
     */
    public function cmo($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
     ...
     *      Aroon Oscillator
     */
    public function aroonosc($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
     ...
     */
    public function adx($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
     ...
     */
    public function stochrsi($pair='BTC/USD', $data=null, $period=7, $trend=false, $trend_period=5)
    {
     ...
     */
    public function roc($pair='BTC/USD', $data=null, $period=7)
    {
     ...
     */
    public function willr($pair='BTC/USD', $data=null, $period=7)
    {
        if (empty($data)) {
            $data = $this->getRecentData($pair);
        }
